...
/*!
 ...
 @param error 错误信息
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager error:(NSError *)error __attribute__ ((deprecated("use naviManager:(AMapNaviManager *)naviManager error:(NSError *)error instead")));

/*!
 @brief naviViewController被展示出来后的回调
 @param naviViewController 被展示出来的ViewController
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager didPresentNaviViewController:(UIViewController *)naviViewController __attribute__ ((deprecated("use naviManager:(AMapNaviManager *)naviManager didPresentNaviViewController:(UIViewController *)naviViewController instead")));
...
/*!
 @brief 驾车路径规划成功后的回调函数
 */
- (void)AMapNaviManagerOnCalculateRouteSuccess:(AMapNaviManager *)naviManager __attribute__ ((deprecated("use naviManagerOnCalculateRouteSuccess:(AMapNaviManager *)naviManager instead")));

/*!
 @brief 驾车路径规划失败后的回调函数
 @param error 计算路径的错误，error.code参照AMapNaviCalcRouteState
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager onCalculateRouteFailure:(NSError *)error __attribute__ ((deprecated("use naviManager:(AMapNaviManager *)naviManager onCalculateRouteFailure:(NSError *)error instead")));

/*!
 @brief 驾车导航时，出现偏航需要重新计算路径时的回调函数
 */
- (void)AMapNaviManagerNeedRecalculateRouteForYaw:(AMapNaviManager *)naviManager __attribute__ ((deprecated("use naviManagerNeedRecalculateRouteForYaw:(AMapNaviManager *)naviManager instead")));

/*!
 @brief 启动导航后回调函数
 @param naviMode 导航类型，参考AMapNaviMode
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager didStartNavi:(AMapNaviMode)naviMode __attribute__ ((deprecated("use naviManager:(AMapNaviManager *)naviManager didStartNavi:(AMapNaviMode)naviMode instead")));

/*!
 @brief 模拟导航到达目的地停止导航后的回调函数
 */
- (void)AMapNaviManagerDidEndEmulatorNavi:(AMapNaviManager *)naviManager __attribute__ ((deprecated("use naviManagerDidEndEmulatorNavi:(AMapNaviManager *)naviManager instead")));

/*!
 @brief 到达目的地后回调
 */
- (void)AMapNaviManagerOnArrivedDestination:(AMapNaviManager *)naviManager __attribute__ ((deprecated("use naviManagerOnArrivedDestination:(AMapNaviManager *)naviManager instead")));

/*!
 @brief 驾车路径导航到达某个途经点的回调函数
 @param wayPointIndex 到达途径点的编号，标号从1开始
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager onArrivedWayPoint:(int)wayPointIndex __attribute__ ((deprecated("use naviManager:(AMapNaviManager *)naviManager onArrivedWayPoint:(int)wayPointIndex instead")));

/*!
 @brief 自车位置更新后的回调函数
 @param naviLocation 当前自车位置信息
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager didUpdateNaviLocation:(AMapNaviLocation *)naviLocation __attribute__ ((deprecated("use naviManager:(AMapNaviManager *)naviManager didUpdateNaviLocation:(AMapNaviLocation *)naviLocation instead")));

/*!
 @brief 模拟和GPS导航过程中,导航信息有更新后的回调函数
 @param naviInfo 当前的导航信息
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager didUpdateNaviInfo:(AMapNaviInfo *)naviInfo __attribute__ ((deprecated("use naviManager:(AMapNaviManager *)naviManager didUpdateNaviInfo:(AMapNaviInfo *)naviInfo instead")));

/*!
 @brief 获取当前播报状态的回调函数
 @return 返回当前是否正在播报
 */
- (BOOL)AMapNaviManagerGetSoundPlayState:(AMapNaviManager *)naviManager __attribute__ ((deprecated("use naviManagerGetSoundPlayState:(AMapNaviManager *)naviManager instead")));
...
/*!
 ...
 @param soundStringType 播报类型，包含导航播报、前方路况播报和整体路况播报，参考AMapNaviSoundType
 */
- (void)AMapNaviManager:(AMapNaviManager *)naviManager playNaviSoundString:(NSString *)soundString soundStringType:(AMapNaviSoundType)soundStringType __attribute__ ((deprecated("use naviManager:(AMapNaviManager *)naviManager playNaviSoundString:(NSString *)soundString soundStringType:(AMapNaviSoundType)soundStringType instead")));

/*!
 @brief 当前方路况光柱信息更新后的回调函数
 */
- (void)AMapNaviManagerDidUpdateTrafficStatuses:(AMapNaviManager *)naviManager __attribute__ ((deprecated("use naviManagerDidUpdateTrafficStatuses:(AMapNaviManager *)naviManager instead")));
